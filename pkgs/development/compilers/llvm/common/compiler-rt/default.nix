...
stdenv.mkDerivation {
  ...
  ] ++ lib.optionals (stdenv.hostPlatform.cxxlib == "libcxx" && haveLibc && stdenv.cc.libcxx == libcxx) [
  ...
  ] ++ lib.optionals (stdenv.hostPlatform.rtlib == "compiler-rt" && haveLibc) [
  ...
  ] ++ lib.optionals (stdenv.hostPlatform.rtlib == "compiler-rt") [
